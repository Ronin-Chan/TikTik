...
const Upload = () => {
    ...
    return (
        <div className='flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#f8f8f8] justify-center'>
            <div className='md:bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-evenly items-center p-14 pt-6 w-[60%]'>
                <div>
                    <div>
                                ...
                                {videoAsset ? (
                                    ...
                                    <label className='cursor-pointer'>
                                        <div className='flex flex-col items-center justify-center h-full'>
                                            ...
                                            <p className='bg-[#915eff] text-center mt-10 rounded text-white text-md font-medium p-2 w-52 outline-none'>
                                                Select File
                                            </p>
                                        </div>
                                        <input
                ...
                <div className='flex flex-col gap-3 pb-10'>
                    ...
                    >
                        {topics.map((topic) => (
                            <option
                                key={topic.name}
                                className='outline-none text-md capitalize bg-white text-gray-700p-2 hover:bg-slate-300'
                            >{topic.name}</option>
                        ))}
                    </select>
